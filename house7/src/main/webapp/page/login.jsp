...
<DIV class=box>
<H4>用户登录</H4>
<FORM id=user method=post name=user action="/page/checkNamePassword">
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
  ...
  <TR>
    ...
    <TD><!-- <input type="password" class="text" name="password" /> --><INPUT 
      id=user_password class=text type=password name=password> </TD></TR><!--
						...
						--></TBODY></TABLE>
<DIV class=buttons> <INPUT name="sub" value=登陆 type=submit> <INPUT onclick='document.location="/page/regs.jsp"' value=注册 type=button>
