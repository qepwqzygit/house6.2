        ...
        columns:[[
            ...
            {field:'del',title:'操作',width:200,
                formatter: function(value,row,index){
                    return "<a href='javascript:delbtn("+row.id+")'>删除</a> | <a href='javascript:selDistrict("+row.id+")'>显示街道信息</a>";
                }
            }
        ]]
    });
    ...
    $("#addFrom").form('submit',{
        ...
        success:function(data){
            ...
            if(data.result==1){
                ...
                $.messager.alert('提示信息','区域已存在!','error');
            }
        }
    });
}
    ...
    $("#upFrom").form('submit',{
        ...
        success:function(data) {
            ...
            if (data.result == 1){
                ...
                $.messager.alert('提示信息','名称不能为空!','error');
            } else {
